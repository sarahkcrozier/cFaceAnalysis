function pcnsParticipantDataExtract

%% DEFINE DATA AND CREATE FILEPATHS
options.paths.data = '/Users/yamaan/Projects/PCNS/cFaceAnalysis';
options.paths.dbExport = [options.paths.data,'RedCap_Export',filesep];
options.study.acronym = 'PCNS';
file = dir([options.paths.dbExport,options.study.acronym,'*.csv']);
